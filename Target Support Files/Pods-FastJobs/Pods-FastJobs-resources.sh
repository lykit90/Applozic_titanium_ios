...
if [[ "$CONFIGURATION" == "Release" ]]; then
  ...
  install_resource "Applozic/Applozic/Images.xcassets/Applozic_img_store/audio_call.imageset/Contents.json"
  ...
  install_resource "Applozic/Applozic/Images.xcassets/Applozic_img_store/missed_call.imageset/Contents.json"
